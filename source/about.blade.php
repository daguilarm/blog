...
@section('body')
    ...
    <div>
        <div class="text-xl text-gray-700"><strong><i>Designing of an Enterprise Resource Planning for the Optimal Management of Agricultural Plots Regarding Quality and Environmental Requirements</i></strong></div>
