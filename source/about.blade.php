...
@section('body')
    ...
    <p>En estos momentos, trabajo como <i>Freelance</i> desarrollando aplicaciones basadas en <strong>Laravel</strong>, <strong>Livewire</strong> y <strong>AlpineJS</strong>.</p>
