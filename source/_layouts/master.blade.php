    ...
    <body class="flex flex-col justify-between min-h-screen bg-gray-100 text-gray-800 leading-normal font-sans">
        ...
        <footer class="w-full flex items-center h-24 bg-white sm:bg-gray-600 sm:text-gray-100 text-center text-sm mt-12 py-4" role="contentinfo">
            <div class="flex-1">
                ...
                <a href="https://belich.dev/blog/legal/cookies" class="sm:text-gray-100 hover:text-gray-300">
                    Política de cookies
                </a> -
                <a href="https://belich.dev/blog/legal/legal" class="sm:text-gray-100 hover:text-gray-300">
                    Política legal
                </a> -
                <a href="https://belich.dev/blog/legal/privacity" class="sm:text-gray-100 hover:text-gray-300">
                    Política privacidad
                </a>
            </div>
        </footer>
