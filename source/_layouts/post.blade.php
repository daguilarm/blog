...
@section('body')
    ...
    <p class="flex justify-start text-gray-600 text-xl md:mt-0"><span>{{ $page->author }}</span><a href="https://twitter.com/daguilarm" target="_black"><img src="/assets/img/twitter.png" alt="twitter" class="opacity-75 hover:opacity-100 h-6 w-6"></a><span>• {{ date('d/m/Y', $page->date) }}</span></p>
