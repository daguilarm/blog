<button class="flex justify-center items-center bg-blue-500 border border-blue-500 relative h-10 px-5 rounded-full lg:hidden focus:outline-none" onclick="navMenu.toggle()">
