    ...
    <div class="flex flex-1 justify-end items-center text-right px-4">
        ...
        >
            ...
            <input
                ...
                v-model="query"
                ref="search"
                class="transition-fast relative block h-10 w-full mr-12 -ml-4 sm:mr-0 sm:w-2/3 lg:w-1/3 lg:focus:w-3/4 bg-gray-100 border border-gray-500 focus:border-blue-500 sm:focus:border-orange-500 outline-none cursor-pointer text-gray-700 px-4 pb-0 pt-px"
            ...
            <transition name="fade">
                <div v-if="query" class="absolute left-0 right-0 md:inset-auto w-full lg:w-3/4 text-left mb-4 md:mt-10">
                    <div class="flex flex-col bg-white border border-b-0 -mt-1 border-blue-400 rounded-b-lg shadow-lg mx-4 md:mx-0">
                        <a
