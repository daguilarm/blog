    ...
    <section id="belich" class="mt-8 p-6">
        ...
        <div class="sm:flex">
            ...
            <div class="mt-12 w-full sm:flex-1 sm:mt-8">
                <img src="/assets/img/projects/livewire-tables.png"
        ...
        <div class="w-full mt-12 sm:mt-0">
            <p><strong>Proyecto en Github:</strong> <a href="https://github.com/daguilarm/livewire-tables">https://github.com/daguilarm/livewire-tables</a></p>
        </div>
    </section>
@endsection
